...
predictions.show(limit=1)
              ...
              <div class="row" style="padding:16px;">
                <div class="col-6">
                  <a href="https://docs.ray.io/en/master/data/data.html" target="_blank">Learn more </a> | <a href="https://docs.ray.io/en/master/data/api/api.html" target="_blank"> API references</a>
                </div>
...
result = trainer.fit()
              ...
              <div class="row" style="padding:16px;">
                <div class="col-6">
                  <a href="https://docs.ray.io/en/master/train/train.html" target="_blank">Learn more </a> | <a href="https://docs.ray.io/en/master/train/api/api.html" target="_blank"> API references</a>
                </div>
                <div class="col-6" style="display: flex; justify-content: flex-end;">
...
result_grid = tuner.fit()
              ...
              <div class="row" style="padding:16px;">
                <div class="col-6">
                  <a href="https://docs.ray.io/en/master/tune/index.html" target="_blank">Learn more </a> | <a href="https://docs.ray.io/en/master/tune/api/api.html" target="_blank"> API references</a>
                </div>
                <div class="col-6" style="display: flex; justify-content: flex-end;">
...
class PredictDeployment:
    ...
    async def __call__(self, http_request: Request) -> str:
        ...
        return self.generate(prompts)
              ...
              <div class="row" style="padding:16px;">
                <div class="col-6">
                   <a href="https://docs.ray.io/en/master/serve/index.html" target="_blank">Learn more </a> | <a href="https://docs.ray.io/en/master/serve/api/index.html" target="_blank"> API references</a>
                </div>
                <div class="col-6" style="display: flex; justify-content: flex-end;">
...
ppo_algo.evaluate()
              ...
              <div class="row" style="padding:16px;">
                <div class="col-6">
                  <a href="https://docs.ray.io/en/master/rllib/index.html" target="_blank">Learn more </a> | <a href="https://docs.ray.io/en/master/rllib/package_ref/index.html" target="_blank"> API references</a>
                </div>
                <div class="col-6" style="display: flex; justify-content: flex-end;">
...
<div class="grid-container">
  <a class="no-underline" href="https://docs.ray.io/en/master/ray-overview/index.html" target="_blank"> <div class="info-box" style="height:100%;">
        <div class="image-header" style="padding:0px;">
   ...
   <a class="no-underline" href="https://docs.ray.io/en/master/ray-overview/installation.html" target="_blank"> <div class="info-box" style="height:100%;">
        <div class="image-header" style="padding:0px;">
...
<div class = "grid-container">
  <div class="info-box-2">
        ...
        <a class="bold-link" style="letter-spacing:0.05em; text-transform:uppercase; font-weight:500;" href="https://docs.ray.io/en/master/ray-overview/getting-started.html#ray-ai-runtime-libraries-quickstart" target="_blank">Learn more about Ray Libraries></a>
  </div>
  <div class="info-box-2">
        <div class="image-header" style="padding:0px;">
        ...
        <a class="bold-link" style="letter-spacing:0.05em; text-transform:uppercase; font-weight:500;" href="https://docs.ray.io/en/master/ray-core/walkthrough.html" target="_blank">Learn more about Core ></a>      
  </div>
  <div class="info-box-2">
        <div class="image-header" style="padding:0px;">
        ...
        <a class="bold-link" style="letter-spacing:0.05em; text-transform:uppercase; font-weight:500;" href="https://docs.ray.io/en/master/cluster/getting-started.html" target="_blank">Learn more about clusters ></a>      
  </div>
</div>
...
<div> 
  ...
  <div> 
    ...
    <a class="no-underline" href="https://docs.ray.io/en/master/ray-contribute/getting-involved.html" target="_blank"> <div class="community-box">
        <div class="image-header">
            <img src="_static/img/mail.png" width="24px" height="24px" />
